  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-blue-50 p-6">
      <div className="text-center w-full max-w-2xl">
        ...
        <p className="text-lg text-blue-700 mt-4 max-w-md mx-auto">
          Rất tiếc, chúng tôi không thể tìm thấy trang bạn yêu cầu. Có thể nó đã
          bị xóa hoặc bạn đã nhập sai địa chỉ.
        </p>

        <Link
          href="/"
          className="mt-10 inline-flex items-center gap-3 bg-blue-600 text-white px-8 py-3 rounded-xl shadow-lg font-semibold transition-all duration-300 hover:bg-blue-700 hover:shadow-blue-400/50  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
